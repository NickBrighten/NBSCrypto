...
#define _BIT_LENGTH_104	 	_BIT_LENGTH_8 *  13
#define _BIT_LENGTH_112	 	_BIT_LENGTH_8 *  14
#define _BIT_LENGTH_120	 	_BIT_LENGTH_8 *  15
#define _BIT_LENGTH_128		_BIT_LENGTH_8 *  16
#define _BIT_LENGTH_136		_BIT_LENGTH_8 *  17
#define _BIT_LENGTH_144		_BIT_LENGTH_8 *  18
#define _BIT_LENGTH_152		_BIT_LENGTH_8 *  19
#define _BIT_LENGTH_160 	_BIT_LENGTH_8 *  20
#define _BIT_LENGTH_168 	_BIT_LENGTH_8 *  21
#define _BIT_LENGTH_176 	_BIT_LENGTH_8 *  22
#define _BIT_LENGTH_184 	_BIT_LENGTH_8 *  23
#define _BIT_LENGTH_192		_BIT_LENGTH_8 *  24
#define _BIT_LENGTH_200		_BIT_LENGTH_8 *  25
#define _BIT_LENGTH_208		_BIT_LENGTH_8 *  26
#define _BIT_LENGTH_216		_BIT_LENGTH_8 *  27
#define _BIT_LENGTH_224		_BIT_LENGTH_8 *  28
#define _BIT_LENGTH_232		_BIT_LENGTH_8 *  29
#define _BIT_LENGTH_240		_BIT_LENGTH_8 *  30
#define _BIT_LENGTH_248		_BIT_LENGTH_8 *  31
#define _BIT_LENGTH_256		_BIT_LENGTH_8 *  32
#define _BIT_LENGTH_264		_BIT_LENGTH_8 *  33
#define _BIT_LENGTH_272		_BIT_LENGTH_8 *  34
#define _BIT_LENGTH_280		_BIT_LENGTH_8 *  35

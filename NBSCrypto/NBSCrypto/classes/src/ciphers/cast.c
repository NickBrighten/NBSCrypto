...
//
//	CAST-128 (CAST5)
//	Authors / Developers		: Carlisle Adams, Stafford Tavares
//	Last Modified (Original)	: 1996
//
//	CAST-256 (CAST6)
//	Authors / Developers		: Carlisle Adams, Stafford Tavares, Howard Heys, Michael Wiener
...
const struct cipher_descriptor cast5_desc =
{
    "cast5",
    7,
    5, 16, 8, 16,
...
static const unsigned char tr[4][8] =
{
...
int cast6_setup(const unsigned char *key, int keylen, int num_rounds, cipher_state *cs)
{
    ...
    e = (keylen >= 20) ? LOAD32(key + 16) : 0;
    f = (keylen >= 24) ? LOAD32(key + 20) : 0;
    g = (keylen >= 28) ? LOAD32(key + 24) : 0;
    h = (keylen >= 32) ? LOAD32(key + 28) : 0;

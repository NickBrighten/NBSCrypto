//
//	kupyna.c
//	Authors / Developers		: Roman Oliynykov, Ivan Gorbenko, Oleksandr Kazymyrov, Victor Ruzhentsev,
//					  Oleksandr Kuznetsov, Yurii Gorbenko, Artem Boiko, Oleksandr Dyrda,
//					  Viktor Dolgov, Andrii Pushkaryov
//	Last Modified (Original)	: 2014
//
...
#pragma mark - DEFINES
const unsigned long long T0[256] = {
...
const unsigned long long T1[256] = {
...
const unsigned long long T2[256] = {
...
const unsigned long long T3[256] = {
...
const unsigned long long T4[256] = {
...
const unsigned long long T5[256] = {
...
const unsigned long long T6[256] = {
...
const unsigned long long T7[256] = {
...
#pragma mark - INLINE
static inline void _G0_256(const unsigned long long *x, unsigned long long *y)
{
    y[0] = T0[(unsigned char)x[0]] ^ T1[(unsigned char)(x[7] >> 8)] ^ T2[(unsigned char)(x[6] >> 16)] ^ T3[(unsigned char)(x[5] >> 24)] ^ T4[(unsigned char)(x[4] >> 32)] ^ T5[(unsigned char)(x[3] >> 40)] ^ T6[(unsigned char)(x[2] >> 48)] ^ T7[(unsigned char)(x[1] >> 56)];
    y[1] = T0[(unsigned char)x[1]] ^ T1[(unsigned char)(x[0] >> 8)] ^ T2[(unsigned char)(x[7] >> 16)] ^ T3[(unsigned char)(x[6] >> 24)] ^ T4[(unsigned char)(x[5] >> 32)] ^ T5[(unsigned char)(x[4] >> 40)] ^ T6[(unsigned char)(x[3] >> 48)] ^ T7[(unsigned char)(x[2] >> 56)];
    y[2] = T0[(unsigned char)x[2]] ^ T1[(unsigned char)(x[1] >> 8)] ^ T2[(unsigned char)(x[0] >> 16)] ^ T3[(unsigned char)(x[7] >> 24)] ^ T4[(unsigned char)(x[6] >> 32)] ^ T5[(unsigned char)(x[5] >> 40)] ^ T6[(unsigned char)(x[4] >> 48)] ^ T7[(unsigned char)(x[3] >> 56)];
    y[3] = T0[(unsigned char)x[3]] ^ T1[(unsigned char)(x[2] >> 8)] ^ T2[(unsigned char)(x[1] >> 16)] ^ T3[(unsigned char)(x[0] >> 24)] ^ T4[(unsigned char)(x[7] >> 32)] ^ T5[(unsigned char)(x[6] >> 40)] ^ T6[(unsigned char)(x[5] >> 48)] ^ T7[(unsigned char)(x[4] >> 56)];
    y[4] = T0[(unsigned char)x[4]] ^ T1[(unsigned char)(x[3] >> 8)] ^ T2[(unsigned char)(x[2] >> 16)] ^ T3[(unsigned char)(x[1] >> 24)] ^ T4[(unsigned char)(x[0] >> 32)] ^ T5[(unsigned char)(x[7] >> 40)] ^ T6[(unsigned char)(x[6] >> 48)] ^ T7[(unsigned char)(x[5] >> 56)];
    y[5] = T0[(unsigned char)x[5]] ^ T1[(unsigned char)(x[4] >> 8)] ^ T2[(unsigned char)(x[3] >> 16)] ^ T3[(unsigned char)(x[2] >> 24)] ^ T4[(unsigned char)(x[1] >> 32)] ^ T5[(unsigned char)(x[0] >> 40)] ^ T6[(unsigned char)(x[7] >> 48)] ^ T7[(unsigned char)(x[6] >> 56)];
    y[6] = T0[(unsigned char)x[6]] ^ T1[(unsigned char)(x[5] >> 8)] ^ T2[(unsigned char)(x[4] >> 16)] ^ T3[(unsigned char)(x[3] >> 24)] ^ T4[(unsigned char)(x[2] >> 32)] ^ T5[(unsigned char)(x[1] >> 40)] ^ T6[(unsigned char)(x[0] >> 48)] ^ T7[(unsigned char)(x[7] >> 56)];
    y[7] = T0[(unsigned char)x[7]] ^ T1[(unsigned char)(x[6] >> 8)] ^ T2[(unsigned char)(x[5] >> 16)] ^ T3[(unsigned char)(x[4] >> 24)] ^ T4[(unsigned char)(x[3] >> 32)] ^ T5[(unsigned char)(x[2] >> 40)] ^ T6[(unsigned char)(x[1] >> 48)] ^ T7[(unsigned char)(x[0] >> 56)];
}

static inline void _G0_512(const unsigned long long *x, unsigned long long *y)
{
    y[0]  = T0[(unsigned char)x[0]]  ^ T1[(unsigned char)(x[15] >> 8)] ^ T2[(unsigned char)(x[14] >> 16)] ^ T3[(unsigned char)(x[13] >> 24)] ^ T4[(unsigned char)(x[12] >> 32)] ^ T5[(unsigned char)(x[11] >> 40)] ^ T6[(unsigned char)(x[10] >> 48)] ^ T7[(unsigned char)(x[5] >> 56)];
    y[1]  = T0[(unsigned char)x[1]]  ^ T1[(unsigned char)(x[0] >> 8)]  ^ T2[(unsigned char)(x[15] >> 16)] ^ T3[(unsigned char)(x[14] >> 24)] ^ T4[(unsigned char)(x[13] >> 32)] ^ T5[(unsigned char)(x[12] >> 40)] ^ T6[(unsigned char)(x[11] >> 48)] ^ T7[(unsigned char)(x[6] >> 56)];
    y[2]  = T0[(unsigned char)x[2]]  ^ T1[(unsigned char)(x[1] >> 8)]  ^ T2[(unsigned char)(x[0] >> 16)]  ^ T3[(unsigned char)(x[15] >> 24)] ^ T4[(unsigned char)(x[14] >> 32)] ^ T5[(unsigned char)(x[13] >> 40)] ^ T6[(unsigned char)(x[12] >> 48)] ^ T7[(unsigned char)(x[7] >> 56)];
    y[3]  = T0[(unsigned char)x[3]]  ^ T1[(unsigned char)(x[2] >> 8)]  ^ T2[(unsigned char)(x[1] >> 16)]  ^ T3[(unsigned char)(x[0] >> 24)]  ^ T4[(unsigned char)(x[15] >> 32)] ^ T5[(unsigned char)(x[14] >> 40)] ^ T6[(unsigned char)(x[13] >> 48)] ^ T7[(unsigned char)(x[8] >> 56)];
    y[4]  = T0[(unsigned char)x[4]]  ^ T1[(unsigned char)(x[3] >> 8)]  ^ T2[(unsigned char)(x[2] >> 16)]  ^ T3[(unsigned char)(x[1] >> 24)]  ^ T4[(unsigned char)(x[0] >> 32)]  ^ T5[(unsigned char)(x[15] >> 40)] ^ T6[(unsigned char)(x[14] >> 48)] ^ T7[(unsigned char)(x[9] >> 56)];
    y[5]  = T0[(unsigned char)x[5]]  ^ T1[(unsigned char)(x[4] >> 8)]  ^ T2[(unsigned char)(x[3] >> 16)]  ^ T3[(unsigned char)(x[2] >> 24)]  ^ T4[(unsigned char)(x[1] >> 32)]  ^ T5[(unsigned char)(x[0] >> 40)]  ^ T6[(unsigned char)(x[15] >> 48)] ^ T7[(unsigned char)(x[10] >> 56)];
    y[6]  = T0[(unsigned char)x[6]]  ^ T1[(unsigned char)(x[5] >> 8)]  ^ T2[(unsigned char)(x[4] >> 16)]  ^ T3[(unsigned char)(x[3] >> 24)]  ^ T4[(unsigned char)(x[2] >> 32)]  ^ T5[(unsigned char)(x[1] >> 40)]  ^ T6[(unsigned char)(x[0] >> 48)]  ^ T7[(unsigned char)(x[11] >> 56)];
    y[7]  = T0[(unsigned char)x[7]]  ^ T1[(unsigned char)(x[6] >> 8)]  ^ T2[(unsigned char)(x[5] >> 16)]  ^ T3[(unsigned char)(x[4] >> 24)]  ^ T4[(unsigned char)(x[3] >> 32)]  ^ T5[(unsigned char)(x[2] >> 40)]  ^ T6[(unsigned char)(x[1] >> 48)]  ^ T7[(unsigned char)(x[12] >> 56)];
    y[8]  = T0[(unsigned char)x[8]]  ^ T1[(unsigned char)(x[7] >> 8)]  ^ T2[(unsigned char)(x[6] >> 16)]  ^ T3[(unsigned char)(x[5] >> 24)]  ^ T4[(unsigned char)(x[4] >> 32)]  ^ T5[(unsigned char)(x[3] >> 40)]  ^ T6[(unsigned char)(x[2] >> 48)]  ^ T7[(unsigned char)(x[13] >> 56)];
    y[9]  = T0[(unsigned char)x[9]]  ^ T1[(unsigned char)(x[8] >> 8)]  ^ T2[(unsigned char)(x[7] >> 16)]  ^ T3[(unsigned char)(x[6] >> 24)]  ^ T4[(unsigned char)(x[5] >> 32)]  ^ T5[(unsigned char)(x[4] >> 40)]  ^ T6[(unsigned char)(x[3] >> 48)]  ^ T7[(unsigned char)(x[14] >> 56)];
    y[10] = T0[(unsigned char)x[10]] ^ T1[(unsigned char)(x[9] >> 8)]  ^ T2[(unsigned char)(x[8] >> 16)]  ^ T3[(unsigned char)(x[7] >> 24)]  ^ T4[(unsigned char)(x[6] >> 32)]  ^ T5[(unsigned char)(x[5] >> 40)]  ^ T6[(unsigned char)(x[4] >> 48)]  ^ T7[(unsigned char)(x[15] >> 56)];
    y[11] = T0[(unsigned char)x[11]] ^ T1[(unsigned char)(x[10] >> 8)] ^ T2[(unsigned char)(x[9] >> 16)]  ^ T3[(unsigned char)(x[8] >> 24)]  ^ T4[(unsigned char)(x[7] >> 32)]  ^ T5[(unsigned char)(x[6] >> 40)]  ^ T6[(unsigned char)(x[5] >> 48)]  ^ T7[(unsigned char)(x[0] >> 56)];
    y[12] = T0[(unsigned char)x[12]] ^ T1[(unsigned char)(x[11] >> 8)] ^ T2[(unsigned char)(x[10] >> 16)] ^ T3[(unsigned char)(x[9] >> 24)]  ^ T4[(unsigned char)(x[8] >> 32)]  ^ T5[(unsigned char)(x[7] >> 40)]  ^ T6[(unsigned char)(x[6] >> 48)]  ^ T7[(unsigned char)(x[1] >> 56)];
    y[13] = T0[(unsigned char)x[13]] ^ T1[(unsigned char)(x[12] >> 8)] ^ T2[(unsigned char)(x[11] >> 16)] ^ T3[(unsigned char)(x[10] >> 24)] ^ T4[(unsigned char)(x[9] >> 32)]  ^ T5[(unsigned char)(x[8] >> 40)]  ^ T6[(unsigned char)(x[7] >> 48)]  ^ T7[(unsigned char)(x[2] >> 56)];
    y[14] = T0[(unsigned char)x[14]] ^ T1[(unsigned char)(x[13] >> 8)] ^ T2[(unsigned char)(x[12] >> 16)] ^ T3[(unsigned char)(x[11] >> 24)] ^ T4[(unsigned char)(x[10] >> 32)] ^ T5[(unsigned char)(x[9] >> 40)]  ^ T6[(unsigned char)(x[8] >> 48)]  ^ T7[(unsigned char)(x[3] >> 56)];
    y[15] = T0[(unsigned char)x[15]] ^ T1[(unsigned char)(x[14] >> 8)] ^ T2[(unsigned char)(x[13] >> 16)] ^ T3[(unsigned char)(x[12] >> 24)] ^ T4[(unsigned char)(x[11] >> 32)] ^ T5[(unsigned char)(x[10] >> 40)] ^ T6[(unsigned char)(x[9] >> 48)]  ^ T7[(unsigned char)(x[4] >> 56)];
}

static inline void _G1_256(const unsigned long long *x, unsigned long long *y, unsigned long long round)
{
    y[0] = T0[(unsigned char)x[0]] ^ T1[(unsigned char)(x[7] >> 8)] ^ T2[(unsigned char)(x[6] >> 16)] ^ T3[(unsigned char)(x[5] >> 24)] ^ T4[(unsigned char)(x[4] >> 32)] ^ T5[(unsigned char)(x[3] >> 40)] ^ T6[(unsigned char)(x[2] >> 48)] ^ T7[(unsigned char)(x[1] >> 56)] ^ (0 << 4) ^ round;
    y[1] = T0[(unsigned char)x[1]] ^ T1[(unsigned char)(x[0] >> 8)] ^ T2[(unsigned char)(x[7] >> 16)] ^ T3[(unsigned char)(x[6] >> 24)] ^ T4[(unsigned char)(x[5] >> 32)] ^ T5[(unsigned char)(x[4] >> 40)] ^ T6[(unsigned char)(x[3] >> 48)] ^ T7[(unsigned char)(x[2] >> 56)] ^ (1 << 4) ^ round;
    y[2] = T0[(unsigned char)x[2]] ^ T1[(unsigned char)(x[1] >> 8)] ^ T2[(unsigned char)(x[0] >> 16)] ^ T3[(unsigned char)(x[7] >> 24)] ^ T4[(unsigned char)(x[6] >> 32)] ^ T5[(unsigned char)(x[5] >> 40)] ^ T6[(unsigned char)(x[4] >> 48)] ^ T7[(unsigned char)(x[3] >> 56)] ^ (2 << 4) ^ round;
    y[3] = T0[(unsigned char)x[3]] ^ T1[(unsigned char)(x[2] >> 8)] ^ T2[(unsigned char)(x[1] >> 16)] ^ T3[(unsigned char)(x[0] >> 24)] ^ T4[(unsigned char)(x[7] >> 32)] ^ T5[(unsigned char)(x[6] >> 40)] ^ T6[(unsigned char)(x[5] >> 48)] ^ T7[(unsigned char)(x[4] >> 56)] ^ (3 << 4) ^ round;
    y[4] = T0[(unsigned char)x[4]] ^ T1[(unsigned char)(x[3] >> 8)] ^ T2[(unsigned char)(x[2] >> 16)] ^ T3[(unsigned char)(x[1] >> 24)] ^ T4[(unsigned char)(x[0] >> 32)] ^ T5[(unsigned char)(x[7] >> 40)] ^ T6[(unsigned char)(x[6] >> 48)] ^ T7[(unsigned char)(x[5] >> 56)] ^ (4 << 4) ^ round;
    y[5] = T0[(unsigned char)x[5]] ^ T1[(unsigned char)(x[4] >> 8)] ^ T2[(unsigned char)(x[3] >> 16)] ^ T3[(unsigned char)(x[2] >> 24)] ^ T4[(unsigned char)(x[1] >> 32)] ^ T5[(unsigned char)(x[0] >> 40)] ^ T6[(unsigned char)(x[7] >> 48)] ^ T7[(unsigned char)(x[6] >> 56)] ^ (5 << 4) ^ round;
    y[6] = T0[(unsigned char)x[6]] ^ T1[(unsigned char)(x[5] >> 8)] ^ T2[(unsigned char)(x[4] >> 16)] ^ T3[(unsigned char)(x[3] >> 24)] ^ T4[(unsigned char)(x[2] >> 32)] ^ T5[(unsigned char)(x[1] >> 40)] ^ T6[(unsigned char)(x[0] >> 48)] ^ T7[(unsigned char)(x[7] >> 56)] ^ (6 << 4) ^ round;
    y[7] = T0[(unsigned char)x[7]] ^ T1[(unsigned char)(x[6] >> 8)] ^ T2[(unsigned char)(x[5] >> 16)] ^ T3[(unsigned char)(x[4] >> 24)] ^ T4[(unsigned char)(x[3] >> 32)] ^ T5[(unsigned char)(x[2] >> 40)] ^ T6[(unsigned char)(x[1] >> 48)] ^ T7[(unsigned char)(x[0] >> 56)] ^ (7 << 4) ^ round;
}

static inline void _G1_512(const unsigned long long *x, unsigned long long *y, unsigned long long round)
{
    y[0]  = T0[(unsigned char)x[0]]  ^ T1[(unsigned char)(x[15] >> 8)] ^ T2[(unsigned char)(x[14] >> 16)] ^ T3[(unsigned char)(x[13] >> 24)] ^ T4[(unsigned char)(x[12] >> 32)] ^ T5[(unsigned char)(x[11] >> 40)] ^ T6[(unsigned char)(x[10] >> 48)] ^ T7[(unsigned char)(x[5] >> 56)]  ^ (0 << 4) ^ round;
    y[1]  = T0[(unsigned char)x[1]]  ^ T1[(unsigned char)(x[0] >> 8)]  ^ T2[(unsigned char)(x[15] >> 16)] ^ T3[(unsigned char)(x[14] >> 24)] ^ T4[(unsigned char)(x[13] >> 32)] ^ T5[(unsigned char)(x[12] >> 40)] ^ T6[(unsigned char)(x[11] >> 48)] ^ T7[(unsigned char)(x[6] >> 56)]  ^ (1 << 4) ^ round;
    y[2]  = T0[(unsigned char)x[2]]  ^ T1[(unsigned char)(x[1] >> 8)]  ^ T2[(unsigned char)(x[0] >> 16)]  ^ T3[(unsigned char)(x[15] >> 24)] ^ T4[(unsigned char)(x[14] >> 32)] ^ T5[(unsigned char)(x[13] >> 40)] ^ T6[(unsigned char)(x[12] >> 48)] ^ T7[(unsigned char)(x[7] >> 56)]  ^ (2 << 4) ^ round;
    y[3]  = T0[(unsigned char)x[3]]  ^ T1[(unsigned char)(x[2] >> 8)]  ^ T2[(unsigned char)(x[1] >> 16)]  ^ T3[(unsigned char)(x[0] >> 24)]  ^ T4[(unsigned char)(x[15] >> 32)] ^ T5[(unsigned char)(x[14] >> 40)] ^ T6[(unsigned char)(x[13] >> 48)] ^ T7[(unsigned char)(x[8] >> 56)]  ^ (3 << 4) ^ round;
    y[4]  = T0[(unsigned char)x[4]]  ^ T1[(unsigned char)(x[3] >> 8)]  ^ T2[(unsigned char)(x[2] >> 16)]  ^ T3[(unsigned char)(x[1] >> 24)]  ^ T4[(unsigned char)(x[0] >> 32)]  ^ T5[(unsigned char)(x[15] >> 40)] ^ T6[(unsigned char)(x[14] >> 48)] ^ T7[(unsigned char)(x[9] >> 56)]  ^ (4 << 4) ^ round;
    y[5]  = T0[(unsigned char)x[5]]  ^ T1[(unsigned char)(x[4] >> 8)]  ^ T2[(unsigned char)(x[3] >> 16)]  ^ T3[(unsigned char)(x[2] >> 24)]  ^ T4[(unsigned char)(x[1] >> 32)]  ^ T5[(unsigned char)(x[0] >> 40)]  ^ T6[(unsigned char)(x[15] >> 48)] ^ T7[(unsigned char)(x[10] >> 56)] ^ (5 << 4) ^ round;
    y[6]  = T0[(unsigned char)x[6]]  ^ T1[(unsigned char)(x[5] >> 8)]  ^ T2[(unsigned char)(x[4] >> 16)]  ^ T3[(unsigned char)(x[3] >> 24)]  ^ T4[(unsigned char)(x[2] >> 32)]  ^ T5[(unsigned char)(x[1] >> 40)]  ^ T6[(unsigned char)(x[0] >> 48)]  ^ T7[(unsigned char)(x[11] >> 56)] ^ (6 << 4) ^ round;
    y[7]  = T0[(unsigned char)x[7]]  ^ T1[(unsigned char)(x[6] >> 8)]  ^ T2[(unsigned char)(x[5] >> 16)]  ^ T3[(unsigned char)(x[4] >> 24)]  ^ T4[(unsigned char)(x[3] >> 32)]  ^ T5[(unsigned char)(x[2] >> 40)]  ^ T6[(unsigned char)(x[1] >> 48)]  ^ T7[(unsigned char)(x[12] >> 56)] ^ (7 << 4) ^ round;
    y[8]  = T0[(unsigned char)x[8]]  ^ T1[(unsigned char)(x[7] >> 8)]  ^ T2[(unsigned char)(x[6] >> 16)]  ^ T3[(unsigned char)(x[5] >> 24)]  ^ T4[(unsigned char)(x[4] >> 32)]  ^ T5[(unsigned char)(x[3] >> 40)]  ^ T6[(unsigned char)(x[2] >> 48)]  ^ T7[(unsigned char)(x[13] >> 56)] ^ (8 << 4) ^ round;
    y[9]  = T0[(unsigned char)x[9]]  ^ T1[(unsigned char)(x[8] >> 8)]  ^ T2[(unsigned char)(x[7] >> 16)]  ^ T3[(unsigned char)(x[6] >> 24)]  ^ T4[(unsigned char)(x[5] >> 32)]  ^ T5[(unsigned char)(x[4] >> 40)]  ^ T6[(unsigned char)(x[3] >> 48)]  ^ T7[(unsigned char)(x[14] >> 56)] ^ (9 << 4) ^ round;
    y[10] = T0[(unsigned char)x[10]] ^ T1[(unsigned char)(x[9] >> 8)]  ^ T2[(unsigned char)(x[8] >> 16)]  ^ T3[(unsigned char)(x[7] >> 24)]  ^ T4[(unsigned char)(x[6] >> 32)]  ^ T5[(unsigned char)(x[5] >> 40)]  ^ T6[(unsigned char)(x[4] >> 48)]  ^ T7[(unsigned char)(x[15] >> 56)] ^ (10 << 4) ^ round;
    y[11] = T0[(unsigned char)x[11]] ^ T1[(unsigned char)(x[10] >> 8)] ^ T2[(unsigned char)(x[9] >> 16)]  ^ T3[(unsigned char)(x[8] >> 24)]  ^ T4[(unsigned char)(x[7] >> 32)]  ^ T5[(unsigned char)(x[6] >> 40)]  ^ T6[(unsigned char)(x[5] >> 48)]  ^ T7[(unsigned char)(x[0] >> 56)]  ^ (11 << 4) ^ round;
    y[12] = T0[(unsigned char)x[12]] ^ T1[(unsigned char)(x[11] >> 8)] ^ T2[(unsigned char)(x[10] >> 16)] ^ T3[(unsigned char)(x[9] >> 24)]  ^ T4[(unsigned char)(x[8] >> 32)]  ^ T5[(unsigned char)(x[7] >> 40)]  ^ T6[(unsigned char)(x[6] >> 48)]  ^ T7[(unsigned char)(x[1] >> 56)]  ^ (12 << 4) ^ round;
    y[13] = T0[(unsigned char)x[13]] ^ T1[(unsigned char)(x[12] >> 8)] ^ T2[(unsigned char)(x[11] >> 16)] ^ T3[(unsigned char)(x[10] >> 24)] ^ T4[(unsigned char)(x[9] >> 32)]  ^ T5[(unsigned char)(x[8] >> 40)]  ^ T6[(unsigned char)(x[7] >> 48)]  ^ T7[(unsigned char)(x[2] >> 56)]  ^ (13 << 4) ^ round;
    y[14] = T0[(unsigned char)x[14]] ^ T1[(unsigned char)(x[13] >> 8)] ^ T2[(unsigned char)(x[12] >> 16)] ^ T3[(unsigned char)(x[11] >> 24)] ^ T4[(unsigned char)(x[10] >> 32)] ^ T5[(unsigned char)(x[9] >> 40)]  ^ T6[(unsigned char)(x[8] >> 48)]  ^ T7[(unsigned char)(x[3] >> 56)]  ^ (14 << 4) ^ round;
    y[15] = T0[(unsigned char)x[15]] ^ T1[(unsigned char)(x[14] >> 8)] ^ T2[(unsigned char)(x[13] >> 16)] ^ T3[(unsigned char)(x[12] >> 24)] ^ T4[(unsigned char)(x[11] >> 32)] ^ T5[(unsigned char)(x[10] >> 40)] ^ T6[(unsigned char)(x[9] >> 48)]  ^ T7[(unsigned char)(x[4] >> 56)]  ^ (15 << 4) ^ round;
}

static inline void _G2_256(const unsigned long long *x, unsigned long long *y, unsigned long long round)
{
    y[0] = (T0[(unsigned char)x[0]] ^ T1[(unsigned char)(x[7] >> 8)] ^ T2[(unsigned char)(x[6] >> 16)] ^ T3[(unsigned char)(x[5] >> 24)] ^ T4[(unsigned char)(x[4] >> 32)] ^ T5[(unsigned char)(x[3] >> 40)] ^ T6[(unsigned char)(x[2] >> 48)] ^ T7[(unsigned char)(x[1] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 0) * 0x10) ^ round)) << 56));
    y[1] = (T0[(unsigned char)x[1]] ^ T1[(unsigned char)(x[0] >> 8)] ^ T2[(unsigned char)(x[7] >> 16)] ^ T3[(unsigned char)(x[6] >> 24)] ^ T4[(unsigned char)(x[5] >> 32)] ^ T5[(unsigned char)(x[4] >> 40)] ^ T6[(unsigned char)(x[3] >> 48)] ^ T7[(unsigned char)(x[2] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 1) * 0x10) ^ round)) << 56));
    y[2] = (T0[(unsigned char)x[2]] ^ T1[(unsigned char)(x[1] >> 8)] ^ T2[(unsigned char)(x[0] >> 16)] ^ T3[(unsigned char)(x[7] >> 24)] ^ T4[(unsigned char)(x[6] >> 32)] ^ T5[(unsigned char)(x[5] >> 40)] ^ T6[(unsigned char)(x[4] >> 48)] ^ T7[(unsigned char)(x[3] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 2) * 0x10) ^ round)) << 56));
    y[3] = (T0[(unsigned char)x[3]] ^ T1[(unsigned char)(x[2] >> 8)] ^ T2[(unsigned char)(x[1] >> 16)] ^ T3[(unsigned char)(x[0] >> 24)] ^ T4[(unsigned char)(x[7] >> 32)] ^ T5[(unsigned char)(x[6] >> 40)] ^ T6[(unsigned char)(x[5] >> 48)] ^ T7[(unsigned char)(x[4] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 3) * 0x10) ^ round)) << 56));
    y[4] = (T0[(unsigned char)x[4]] ^ T1[(unsigned char)(x[3] >> 8)] ^ T2[(unsigned char)(x[2] >> 16)] ^ T3[(unsigned char)(x[1] >> 24)] ^ T4[(unsigned char)(x[0] >> 32)] ^ T5[(unsigned char)(x[7] >> 40)] ^ T6[(unsigned char)(x[6] >> 48)] ^ T7[(unsigned char)(x[5] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 4) * 0x10) ^ round)) << 56));
    y[5] = (T0[(unsigned char)x[5]] ^ T1[(unsigned char)(x[4] >> 8)] ^ T2[(unsigned char)(x[3] >> 16)] ^ T3[(unsigned char)(x[2] >> 24)] ^ T4[(unsigned char)(x[1] >> 32)] ^ T5[(unsigned char)(x[0] >> 40)] ^ T6[(unsigned char)(x[7] >> 48)] ^ T7[(unsigned char)(x[6] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 5) * 0x10) ^ round)) << 56));
    y[6] = (T0[(unsigned char)x[6]] ^ T1[(unsigned char)(x[5] >> 8)] ^ T2[(unsigned char)(x[4] >> 16)] ^ T3[(unsigned char)(x[3] >> 24)] ^ T4[(unsigned char)(x[2] >> 32)] ^ T5[(unsigned char)(x[1] >> 40)] ^ T6[(unsigned char)(x[0] >> 48)] ^ T7[(unsigned char)(x[7] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 6) * 0x10) ^ round)) << 56));
    y[7] = (T0[(unsigned char)x[7]] ^ T1[(unsigned char)(x[6] >> 8)] ^ T2[(unsigned char)(x[5] >> 16)] ^ T3[(unsigned char)(x[4] >> 24)] ^ T4[(unsigned char)(x[3] >> 32)] ^ T5[(unsigned char)(x[2] >> 40)] ^ T6[(unsigned char)(x[1] >> 48)] ^ T7[(unsigned char)(x[0] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((7 - 7) * 0x10) ^ round)) << 56));
}

static inline void _G2_512(const unsigned long long *x, unsigned long long *y, unsigned long long round)
{
    y[0]  = (T0[(unsigned char)x[0]]  ^ T1[(unsigned char)(x[15] >> 8)] ^ T2[(unsigned char)(x[14] >> 16)] ^ T3[(unsigned char)(x[13] >> 24)] ^ T4[(unsigned char)(x[12] >> 32)] ^ T5[(unsigned char)(x[11] >> 40)] ^ T6[(unsigned char)(x[10] >> 48)] ^ T7[(unsigned char)(x[5] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 0)  * 0x10) ^ round)) << 56));
    y[1]  = (T0[(unsigned char)x[1]]  ^ T1[(unsigned char)(x[0] >> 8)]  ^ T2[(unsigned char)(x[15] >> 16)] ^ T3[(unsigned char)(x[14] >> 24)] ^ T4[(unsigned char)(x[13] >> 32)] ^ T5[(unsigned char)(x[12] >> 40)] ^ T6[(unsigned char)(x[11] >> 48)] ^ T7[(unsigned char)(x[6] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 1)  * 0x10) ^ round)) << 56));
    y[2]  = (T0[(unsigned char)x[2]]  ^ T1[(unsigned char)(x[1] >> 8)]  ^ T2[(unsigned char)(x[0] >> 16)]  ^ T3[(unsigned char)(x[15] >> 24)] ^ T4[(unsigned char)(x[14] >> 32)] ^ T5[(unsigned char)(x[13] >> 40)] ^ T6[(unsigned char)(x[12] >> 48)] ^ T7[(unsigned char)(x[7] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 2)  * 0x10) ^ round)) << 56));
    y[3]  = (T0[(unsigned char)x[3]]  ^ T1[(unsigned char)(x[2] >> 8)]  ^ T2[(unsigned char)(x[1] >> 16)]  ^ T3[(unsigned char)(x[0] >> 24)]  ^ T4[(unsigned char)(x[15] >> 32)] ^ T5[(unsigned char)(x[14] >> 40)] ^ T6[(unsigned char)(x[13] >> 48)] ^ T7[(unsigned char)(x[8] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 3)  * 0x10) ^ round)) << 56));
    y[4]  = (T0[(unsigned char)x[4]]  ^ T1[(unsigned char)(x[3] >> 8)]  ^ T2[(unsigned char)(x[2] >> 16)]  ^ T3[(unsigned char)(x[1] >> 24)]  ^ T4[(unsigned char)(x[0] >> 32)]  ^ T5[(unsigned char)(x[15] >> 40)] ^ T6[(unsigned char)(x[14] >> 48)] ^ T7[(unsigned char)(x[9] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 4)  * 0x10) ^ round)) << 56));
    y[5]  = (T0[(unsigned char)x[5]]  ^ T1[(unsigned char)(x[4] >> 8)]  ^ T2[(unsigned char)(x[3] >> 16)]  ^ T3[(unsigned char)(x[2] >> 24)]  ^ T4[(unsigned char)(x[1] >> 32)]  ^ T5[(unsigned char)(x[0] >> 40)]  ^ T6[(unsigned char)(x[15] >> 48)] ^ T7[(unsigned char)(x[10] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 5)  * 0x10) ^ round)) << 56));
    y[6]  = (T0[(unsigned char)x[6]]  ^ T1[(unsigned char)(x[5] >> 8)]  ^ T2[(unsigned char)(x[4] >> 16)]  ^ T3[(unsigned char)(x[3] >> 24)]  ^ T4[(unsigned char)(x[2] >> 32)]  ^ T5[(unsigned char)(x[1] >> 40)]  ^ T6[(unsigned char)(x[0] >> 48)]  ^ T7[(unsigned char)(x[11] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 6)  * 0x10) ^ round)) << 56));
    y[7]  = (T0[(unsigned char)x[7]]  ^ T1[(unsigned char)(x[6] >> 8)]  ^ T2[(unsigned char)(x[5] >> 16)]  ^ T3[(unsigned char)(x[4] >> 24)]  ^ T4[(unsigned char)(x[3] >> 32)]  ^ T5[(unsigned char)(x[2] >> 40)]  ^ T6[(unsigned char)(x[1] >> 48)]  ^ T7[(unsigned char)(x[12] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 7)  * 0x10) ^ round)) << 56));
    y[8]  = (T0[(unsigned char)x[8]]  ^ T1[(unsigned char)(x[7] >> 8)]  ^ T2[(unsigned char)(x[6] >> 16)]  ^ T3[(unsigned char)(x[5] >> 24)]  ^ T4[(unsigned char)(x[4] >> 32)]  ^ T5[(unsigned char)(x[3] >> 40)]  ^ T6[(unsigned char)(x[2] >> 48)]  ^ T7[(unsigned char)(x[13] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 8)  * 0x10) ^ round)) << 56));
    y[9]  = (T0[(unsigned char)x[9]]  ^ T1[(unsigned char)(x[8] >> 8)]  ^ T2[(unsigned char)(x[7] >> 16)]  ^ T3[(unsigned char)(x[6] >> 24)]  ^ T4[(unsigned char)(x[5] >> 32)]  ^ T5[(unsigned char)(x[4] >> 40)]  ^ T6[(unsigned char)(x[3] >> 48)]  ^ T7[(unsigned char)(x[14] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 9)  * 0x10) ^ round)) << 56));
    y[10] = (T0[(unsigned char)x[10]] ^ T1[(unsigned char)(x[9] >> 8)]  ^ T2[(unsigned char)(x[8] >> 16)]  ^ T3[(unsigned char)(x[7] >> 24)]  ^ T4[(unsigned char)(x[6] >> 32)]  ^ T5[(unsigned char)(x[5] >> 40)]  ^ T6[(unsigned char)(x[4] >> 48)]  ^ T7[(unsigned char)(x[15] >> 56)]) + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 10) * 0x10) ^ round)) << 56));
    y[11] = (T0[(unsigned char)x[11]] ^ T1[(unsigned char)(x[10] >> 8)] ^ T2[(unsigned char)(x[9] >> 16)]  ^ T3[(unsigned char)(x[8] >> 24)]  ^ T4[(unsigned char)(x[7] >> 32)]  ^ T5[(unsigned char)(x[6] >> 40)]  ^ T6[(unsigned char)(x[5] >> 48)]  ^ T7[(unsigned char)(x[0] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 11) * 0x10) ^ round)) << 56));
    y[12] = (T0[(unsigned char)x[12]] ^ T1[(unsigned char)(x[11] >> 8)] ^ T2[(unsigned char)(x[10] >> 16)] ^ T3[(unsigned char)(x[9] >> 24)]  ^ T4[(unsigned char)(x[8] >> 32)]  ^ T5[(unsigned char)(x[7] >> 40)]  ^ T6[(unsigned char)(x[6] >> 48)]  ^ T7[(unsigned char)(x[1] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 12) * 0x10) ^ round)) << 56));
    y[13] = (T0[(unsigned char)x[13]] ^ T1[(unsigned char)(x[12] >> 8)] ^ T2[(unsigned char)(x[11] >> 16)] ^ T3[(unsigned char)(x[10] >> 24)] ^ T4[(unsigned char)(x[9] >> 32)]  ^ T5[(unsigned char)(x[8] >> 40)]  ^ T6[(unsigned char)(x[7] >> 48)]  ^ T7[(unsigned char)(x[2] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 13) * 0x10) ^ round)) << 56));
    y[14] = (T0[(unsigned char)x[14]] ^ T1[(unsigned char)(x[13] >> 8)] ^ T2[(unsigned char)(x[12] >> 16)] ^ T3[(unsigned char)(x[11] >> 24)] ^ T4[(unsigned char)(x[10] >> 32)] ^ T5[(unsigned char)(x[9] >> 40)]  ^ T6[(unsigned char)(x[8] >> 48)]  ^ T7[(unsigned char)(x[3] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 14) * 0x10) ^ round)) << 56));
    y[15] = (T0[(unsigned char)x[15]] ^ T1[(unsigned char)(x[14] >> 8)] ^ T2[(unsigned char)(x[13] >> 16)] ^ T3[(unsigned char)(x[12] >> 24)] ^ T4[(unsigned char)(x[11] >> 32)] ^ T5[(unsigned char)(x[10] >> 40)] ^ T6[(unsigned char)(x[9] >> 48)]  ^ T7[(unsigned char)(x[4] >> 56)])  + (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - 15) * 0x10) ^ round)) << 56));
}

static inline void _P_256(unsigned long long *x, unsigned long long *y, unsigned long long round)
{
...
static inline void _P_512(unsigned long long *x, unsigned long long *y, unsigned long long round)
{
...
static inline void _Q_256(unsigned long long *x, unsigned long long *y, unsigned long long round)
{
    for (unsigned int j = 0; j < 8; ++j) {
	x[j] += (0x00F0F0F0F0F0F0F3ULL ^ (((unsigned long long)(((7 - j) * 0x10) ^ round)) << 56));
    }
...
static inline void _Q_512(unsigned long long *x, unsigned long long *y, unsigned long long round)
{
    for (unsigned int j = 0; j < 16; ++j) {
	x[j] += (0x00F0F0F0F0F0F0F3ull ^ (((unsigned long long)(((15 - j) * 0x10) ^ round)) << 56));
    }
...
static inline void _transform_256(hash_state *hs, const union kupyna256_t* b)
{
    union kupyna256_t AQ1;
    union kupyna256_t AP1;
    union kupyna256_t tmp;

    for (unsigned int column=0; column<8; ++column) {
	AP1.q[column] = hs->kupyna256.h.q[column] ^ b->q[column];
	AQ1.q[column] = b->q[column];
    }

    for (unsigned char r = 0; r < 10; r += 2) {
	_P_256(AP1.q, tmp.q, r);
	_Q_256(AQ1.q, tmp.q, r);
    }

    for (unsigned int column=0; column<8; ++column) {
	hs->kupyna256.h.q[column] ^= AP1.q[column] ^ AQ1.q[column];
    }
}

static inline void _transform_512(hash_state *hs, const union kupyna512_t* b)
{
    union kupyna512_t AQ1;
    union kupyna512_t AP1;
    union kupyna512_t tmp;
    unsigned int column;
    unsigned char r;

    for (column=0; column<16; ++column) {
	AP1.q[column] = hs->kupyna512.h.q[column] ^ b->q[column];
	AQ1.q[column] = b->q[column];
    }

    for (r=0; r<14; r+=2) {
	_P_512(AP1.q, tmp.q, r);
	_Q_512(AQ1.q, tmp.q, r);
    }

    for (column=0; column<16; ++column) {
	hs->kupyna512.h.q[column] ^= AP1.q[column] ^ AQ1.q[column];
    }
}

static inline void _outputTransform(hash_state *hs)
{
    if(hs->kupyna256.hashbitlen == 256){
	union kupyna256_t t1;
	union kupyna256_t t2;

	memcpy(t1.q, hs->kupyna256.h.q, sizeof(t1));
	...
	for (unsigned int column=0; column<8; ++column) {
	    hs->kupyna256.h.q[column] ^= t1.q[column];
	}
    }

    if(hs->kupyna512.hashbitlen == 512){
	union kupyna512_t t1;
	union kupyna512_t t2;
	unsigned int column;
	unsigned char r;

	memcpy(t1.q, hs->kupyna512.h.q, sizeof(t1));
	...
	for (column=0; column<16; ++column) {
	    hs->kupyna512.h.q[column] ^= t1.q[column];
	}
    }
}

static inline int _kupyna_init(hash_state *hs, int hashbitlen)
{
    switch (hashbitlen) {
	case 256:{
	    hs->kupyna256.pos    = 0;
	    hs->kupyna256.total  = 0;
	    memset(hs->kupyna256.h.q, 0, sizeof(hs->kupyna256.h.q));
	    hs->kupyna256.h.b[0] = 64;
	    hs->kupyna256.hashbitlen = 256;
	    return NBSCrypto_OK;
	    break;
	}
	case 384:{
	...
	case 512:{
	    hs->kupyna512.pos    = 0;
	    hs->kupyna512.total  = 0;
	    memset(hs->kupyna512.h.q, 0, sizeof(hs->kupyna512.h.q));
	    hs->kupyna512.h.b[0] = 128;
	    hs->kupyna512.hashbitlen = 512;
	    return NBSCrypto_OK;
	    break;
	}
    }
...
int kupyna_256_init(hash_state *hs){return _kupyna_init(hs, 256);}
int kupyna_512_init(hash_state *hs){return _kupyna_init(hs, 512);}
...
int kupyna_process(hash_state *hs, const unsigned char *in, unsigned long inlen)
{
    ...
    if (hs->kupyna256.hashbitlen == 256) {
	if (hs->kupyna256.pos && hs->kupyna256.pos + inlen >= 64) {
	    memcpy(hs->kupyna256.m.b + hs->kupyna256.pos, in, 64 - hs->kupyna256.pos);
	    _transform_256(hs, &hs->kupyna256.m);
	    inlen	-= 64 - hs->kupyna256.pos;
	    in	+= 64 - hs->kupyna256.pos;
	    hs->kupyna256.pos = 0;
	}

	while (inlen >= 64) {
	    memcpy(hs->kupyna256.m.b, in, 64);
	    _transform_256(hs, &hs->kupyna256.m);
	    inlen	-= 64;
	    in	+= 64;
	}
	...
	if (inlen) {
	    memcpy(hs->kupyna256.m.b + hs->kupyna256.pos, in, inlen);
	    hs->kupyna256.pos += inlen;
	}

	hs->kupyna256.total += l * 8;
    }

    if (hs->kupyna512.hashbitlen == 512) {
	if (hs->kupyna512.pos && hs->kupyna512.pos + inlen >= 128) {
	    memcpy(hs->kupyna512.m.b + hs->kupyna512.pos, in, 128 - hs->kupyna512.pos);
	    _transform_512(hs, &hs->kupyna512.m);
	    inlen	-= 128 - hs->kupyna512.pos;
	    in		+= 128 - hs->kupyna512.pos;
	    hs->kupyna512.pos = 0;
	}

	while (inlen >= 128) {
	    memcpy(hs->kupyna512.m.b, in, 128);
	    _transform_512(hs, &hs->kupyna512.m);
	    inlen	-= 128;
	    in 		+= 128;
	}
	...
	if (inlen) {
	    memcpy(hs->kupyna512.m.b + hs->kupyna512.pos, in, inlen);
	    hs->kupyna512.pos += inlen;
	}

	hs->kupyna512.total += l * 8;
    }
...
{
    if (hs->kupyna256.hashbitlen == 256) {
	int bits = hs->kupyna256.hashbitlen;
	hs->kupyna256.m.b[hs->kupyna256.pos] = 0x80;
	++hs->kupyna256.pos;
	if(hs->kupyna256.pos > 52){
	    memset(hs->kupyna256.m.b + hs->kupyna256.pos, 0, 64 - hs->kupyna256.pos);
	    _transform_256(hs, &hs->kupyna256.m);
	    hs->kupyna256.pos = 0;
	}

	memset(hs->kupyna256.m.b + hs->kupyna256.pos, 0, 64 - hs->kupyna256.pos);
	memcpy(hs->kupyna256.m.b + 52, &hs->kupyna256.total, sizeof(unsigned long long));

	_transform_256(hs, &hs->kupyna256.m);
	_outputTransform(hs);

	memcpy(out, hs->kupyna256.h.b + 64 - bits/8, bits/8);
    }

    if (hs->kupyna512.hashbitlen == 512) {
	int bits = hs->kupyna512.hashbitlen;
	hs->kupyna512.m.b[hs->kupyna512.pos] = 0x80;
	++hs->kupyna512.pos;
	if (hs->kupyna512.pos > 116) {
	    memset(hs->kupyna512.m.b + hs->kupyna512.pos, 0, 128 - hs->kupyna512.pos);
	    _transform_512(hs, &hs->kupyna512.m);
	    hs->kupyna512.pos = 0;
	}

	memset(hs->kupyna512.m.b + hs->kupyna512.pos, 0, 128 - hs->kupyna512.pos);
	memcpy(hs->kupyna512.m.b + 116, &hs->kupyna512.total, sizeof(unsigned long long));

	_transform_512(hs, &hs->kupyna512.m);
	_outputTransform(hs);

	memcpy(out, hs->kupyna512.h.b + 128 - bits/8, bits/8);
